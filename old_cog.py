            ...
            for i, cfg in enumerate(shuffled_nodes):
                try:
                    if "uri" in cfg:
                        ...
                        uri = _normalize_lavalink_uri(f"{scheme}://{host}:{port}")
    ...
    async def play(self, interaction: discord.Interaction, query: str) -> None:
        ...
        try:
            ...
            if not results:
                ...
                return
            # Keep playback flow aligned with the reference logic:
            # always keep autoplay enabled and only start playback when idle.
